...
IP Fire firewall download link: https://www.ipfire.org/

3. Build an Elastic Stack on a seperate x64 Linux VM: this can be done by following a guide such as this one: https://logz.io/learn/complete-guide-elk-stack/ you
...
Filebeat download link: (most machines are x64 if you are unsure, if you are trying to build an x32 variant to pull IOCs of malware targeting x32 machines then use the x32 download.

(x64) https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-7.8.1-windows-x86_64.msi

(x32) https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-7.8.1-windows-x86.msi
...
NOVnc donwload link: https://github.com/novnc/noVNC (recommended to install via Snap)

Nginx download link: http://nginx.org/download/nginx-1.19.2.tar.gz
...
14. iFrames! You can pull these out of Kibana to put them where I've put placeholders in the HTML by going to the top left of your visualization, Share, Embed Code, Saved        Object, Copy iFrame code. If you're sinful enough to ignore this, and click short URL or the other option, it will just give you a saved version, and you wont see any new logs, the saved object is interactive but it has a very long URL.
